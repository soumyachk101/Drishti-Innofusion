// Drishti v0.1 — animated flow-field canvas background | 11-Jul-2026
...
export default function NeuralBackground({
  className,
  color = "#38c6f4", // phosphor (matches accent.400 token)
  trailOpacity = 0.15,
  particleCount = 600,
  speed = 1,
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Assuming light mode for this effect now:
      ctx.fillStyle = `rgba(10, 17, 30, ${trailOpacity})`; 
